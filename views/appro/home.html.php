        ...
        <div class="row">
            <div class="col-md-8">
                <ol class="breadcrumb bg-dark p-2">
                    ...
                    <li class="breadcrumb-item active">Approvissionnement</li>
                </ol>
            </div>
            <div class="col-md-4">
                <div class="justify-content-between">
                    <a class="btn btn-primary text-white" data-toggle="modal" data-target="#modal-lg">
                        <i class="fa fa-plus"></i> Approvissionnement
                    </a>
    ...
    <div class="card shadow">
        ...
        <div class="card-body pb-1">
            <table id="DataTable" class="table table-striped">
                ...
                <tbody>
                    <?php foreach ($findAllStocks as $key => $value) { ?>
                        <tr>
                            <td><?= $value->codeMarchandise ?></td>
                            <td><?= $value->designation ?></td>
                            <td><?= $value->qteEntreer ?></td>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header bg-dark">
                <div>
                    <span class="h5 text-uppercase">approvissionnement MARCHANDISES</span>
                </div>
            ...
            <div class="modal-body">
                <form action="index.php?controller=stock&task=create" method="post">

                    <div class="form-group">
                        <label for="fournisseur" class="form-label">Fournisseurs</label>
                        <input list="fournisseurs" name="fournisseur" id="fournisseur" class="form-control" placeholder="-- SELECTIONNER UN FOURNISSEUR --">
                        <datalist id="fournisseurs">
                            <?php foreach ($fournisseurs as $key => $value) { ?>
                                <option value="<?= $value->codeFournisseur ?>"><?= $value->nomFourn . " " . $value->postNomFourn ?></option>
                            <?php
                            } ?>
                        </datalist>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" list="marchandises" name="marchandise" id="marchandise" class="form-control" placeholder="-- SELECTIONE UNE MARCHANDISE --">
                        <datalist id="marchandises">
                            <?php foreach ($marchandises as $key => $value) { ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="quantite" id="quantite" class="form-control" placeholder="Ex : 100">
                    </div>
                    <div class="form-group">
                        <label for="" class="form-label">Prix unitaire</label>
                        <input type="number" name="prixUnitaire" id="prixUnitaire" class="form-control" placeholder="Ex : 10 OU 2,5">
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-footer justify-content-between">
                <button type="reset" class="btn btn-outline-dark shadow">
                    <i class="fa fa-clean"></i> Effacer</button>
                <button type="submit" class="btn btn-outline-primary shadow">
                    <i class="fa fa-save"></i> Enregistrer l'opération</button>
            </div>
            </form>
        </div>
    </div>
...
<div class="modal fade" id="modal-magasin">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="index.php?controller=stock&task=createLivraison" method="post">
                    <div class="form-group">
